...
/************************************************************************/
/**
 * @output site-includes/js/media-models.js
 */
...
_.extend( media, /** @lends wp.media */{
	 ...
	 *
	 * See wp.template() in `site-includes/js/wp-util.js`.
	 *
	 ...
	 * See wp.ajax.post() in `site-includes/js/wp-util.js`.
	 *
	 ...
	 * See wp.ajax.send() in `site-includes/js/wp-util.js`.
	 *
